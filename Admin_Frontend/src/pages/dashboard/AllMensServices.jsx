...
const AllMensServices = () => {
  ...
  const sortedBlogs = [...mymenservices].sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt));
  ...
  return (
    <div className="max-w-6xl mx-auto px-0 sm:px-6 lg:px-8">
      <div className="flex flex-col sm:flex-row justify-between items-center mb-6">
        ...
        <Link
          to="/dashboard/mens-services/create"
    ...
    : service.description} */}
                    ...
                    <td className="px-4 sm:px-6 py-4 text-right">
                      <div className="flex items-center justify-end space-x-3">
                        <Link to={`/dashboard/mens-services/create/${service._id}`} className="text-indigo-600 hover:text-indigo-900">
...
export default AllMensServices;
