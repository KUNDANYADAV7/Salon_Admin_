...
const { allwomenservices, getWomenServiceBySubtitle, loading } = useWomen();
  ...
  {filteredServices.length === 0 ? (
    ...
    <div className="flex flex-col items-center justify-center h-64 bg-gray-100 rounded-lg shadow-md">
      ...
      <p className="text-sm text-gray-500 text-center">This service has no category assigned.</p>
    </div>
  ) : (
    <div className="bg-white rounded-lg overflow-hidden">
  <div className="overflow-x-auto">
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 justify-items-center p-4">
